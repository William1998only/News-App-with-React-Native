...
class Sports extends React.Component { 
    ...
    componentDidMount() {
        axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=d8ee47eaa0b94b9ba97bbea8c3eb38ff`)
            .then(res => {
    ...
    render() {  
        ...
        return (           
            <View style={styles.Header}>
                <View style={{width: "100%", height: "13%", backgroundColor: '#00ff00'}}>
